...
\begin{itemize}
\item Focuses on gamma-ray burst observations and multi-wavelength studies.
\end{itemize}
2. **Radiation properties of a regular black hole embedded in a Dehnen-type dark matter halo with a thin accretion disk**
\begin{itemize}
\item Investigates the radiation properties around a regular black hole embedded in a specific dark matter distribution.
\end{itemize}
3. **Fermion Condensate Inflation, Dynamical Waterfall Mechanism and Primordial Black Holes**
\begin{itemize}
\item Explores fermion condensate inflation and its role in primordial black holes (PBHs) which can contribute to dark matter.
\end{itemize}
\subsection*{Galaxies}
4. **SPURS: Bursty Star Formation in an Extremely Luminous Weak Emission Line Galaxy at \(z=9.3\)**
\begin{itemize}
\item Studies star formation in a super-luminous galaxy with weak emission lines at high redshift.
\end{itemize}
5. **Signatures of Very Massive Stars in the Epoch of Reionization**
\begin{itemize}
\item Analyzes strong P-Cygni profiles and HeII emissions in UV-bright galaxies to infer the presence of very massive stars during reionization.
\end{itemize}
6. **Multi-wavelength study of EP250416a / GRB 250416C: An Optically Dark Long GRB with a Late Jet Break**
\begin{itemize}
\item Also relevant here for studying galaxy properties via gamma-ray bursts.
\end{itemize}
7. **AMiBA-6m CMB and SZ Lensing Cross-correlation Measurement Using a New Method of Analytical Template Estimation**
\begin{itemize}
\item Studies cosmic microwave background (CMB) lensing effects, though primarily related to cosmology.
\end{itemize}
8. **Radiation properties of a regular black hole embedded in a Dehnen-type dark matter halo with a thin accretion disk**
\begin{itemize}
\item Also relevant here for understanding the radiation from galactic centers.
\end{itemize}
\subsection*{Cosmology}
9. **AMiBA-6m CMB and SZ Lensing Cross-correlation Measurement Using a New Method of Analytical Template Estimation**
\begin{itemize}
\item Focuses on cosmic microwave background lensing measurements, important in cosmological studies.
\end{itemize}
10. **Fermion Condensate Inflation, Dynamical Waterfall Mechanism and Primordial Black Holes**
\begin{itemize}
\item Studies inflationary models and their implications for the early universe.
\end{itemize}
\subsection*{Astrophysics}
11. **Signatures of Very Massive Stars in the Epoch of Reionization**
\begin{itemize}
\item Focuses on very massive stars’ effects on galaxy formation and reionization.
\end{itemize}
12. **Radiation properties of a regular black hole embedded in a Dehnen-type dark matter halo with a thin accretion disk**
\begin{itemize}
\item Studies radiation from accretion disks around black holes, important for astrophysics.
\end{itemize}
\subsection*{Summary}
\begin{itemize}
\item **Dark Matter**: Focuses on the role of primordial black holes and black hole radiation properties within specific dark matter distributions.
\end{itemize}
\begin{itemize}
\item **Galaxies**: Emphasizes high-redshift galaxy studies including star formation, emission line analysis, and gamma-ray burst interactions with galaxies.
\end{itemize}
\begin{itemize}
\item **Cosmology**: Deals with inflationary models, CMB lensing measurements, and the early universe's conditions.
\end{itemize}
\begin{itemize}
\item **Astrophysics**: Concentrates on radiation properties of accretion disks around black holes and the signatures of very massive stars during reionization.
\end{itemize}
