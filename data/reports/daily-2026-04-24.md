...
**Pool:** 18 recent papers gathered. **Presenting:** 13 chosen by the local model for this briefing.

**Selection note:** _Selection failed (timed out); using newest k._

## Recent context and open threads

Recent research briefings reveal several persistent themes across the broad fields of astrophysics, with particular emphasis on the interplay between local and global processes shaping cosmic structures. A recurring debate centers around the role of bars in regulating star formation within spiral galaxies, where studies suggest that while active star formation is largely driven by local conditions, quenching mechanisms are more influenced by broader galactic properties such as black hole masses.

In dark matter research, there remains significant tension regarding exotic scenarios and their observational signatures. Theoretical models exploring inelastic self-interacting dark matter and the role of global cosmic strings continue to be scrutinized for their ability to influence large-scale structure formation and observable phenomena like acoustic oscillations in power spectra. Notably, primordial black holes are increasingly considered as viable macroscopic dark matter candidates, driven by higher-dimensional models that enable massive growth during early Universe epochs.

Gravitational lensing studies have shifted towards exploring higher-order statistical measures, such as fourth-order correlations between shear and galaxy positions, to detect non-Gaussian features in the cosmic web. This approach aims to uncover more detailed insights into the structure of the universe beyond traditional second-order statistics.

Observations of galaxy clusters continue to highlight the importance of magnetic fields in shaping intra-cluster environments, with high-resolution spectro-polarimetric data revealing new details about cluster dynamics and magnetic field strength. However, there is an ongoing need for robust observational evidence to fully constrain these models and their implications for galaxy formation within cluster environments.

Open questions flagged across multiple briefings include the precise role of dark matter in galactic evolution, the detection capabilities for exotic dark matter candidates such as primordial black holes via radio telescopes, and the exact mechanisms governing star formation and quenching processes. The quest for definitive observational signatures continues to drive theoretical advancements and observational efforts.

---

## Research briefing (synthesized)

Here's a summary of some key astrophysics and cosmology papers published recently, focusing on dark matter and galaxies:

### Dark Matter

1. **"Radiation properties of a regular black hole embedded in a Dehnen-type dark matter halo with a thin accretion disk"**
   - This paper investigates the shadow, timelike geodesic structure, radiation properties of thin accretion disks, and optical appearance of a static spherically symmetric regular black hole using observational data from M87* and Sgr A*. The parameter $a$ is constrained at both $1σ$ and $2σ$ confidence levels. The study examines how the parameter $a$ and viewing angle affect the black hole image, revealing that larger $a$ enlarges the effective radiation area of the accretion disk.

2. **"Fermion Condensate Inflation, Dynamical Waterfall Mechanism and Primordial Black Holes"**
   - This paper explores a fermion condensate inflation model where four-fermion interactions induced by spacetime torsion replace scalar fields beyond the Standard Model. It discusses how this framework can lead to a dynamical waterfall mechanism and the formation of non-topological solitons (Q-balls) that act as seeds for primordial black holes, which could provide observational tests of the model.

### Galaxies

1. **"Multi-wavelength study of EP250416a / GRB 250416C: An Optically Dark Long GRB with a Late Jet Break"**
   - This paper presents a multi-wavelength analysis of the γ/X-ray transient EP250416a, also known as GRB 250416C. The study examines prompt emission, afterglow evolution, and physical origin through observations spanning γ-rays, X-rays, and optical bands. Key findings include an isotropic energy calculation and classification as an X-ray rich (XRR) GRB with a late jet break.

2. **"Signatures of Very Massive Stars in the Epoch of Reionization"**
   - This paper presents ultra-deep rest-frame UV spectroscopy data for two galaxies at $z\sim 8.7$ using JWST. The spectra show strong P-Cygni profiles and significant HeII emission, which synthetic models suggest are best fit by very massive stars (VMS). These VMS-dominated systems imply extremely young ages ($1.5-2.0$ Myr) and high ionizing photon production efficiencies.

3. **"SPURS: Bursty Star Formation in an Extremely Luminous Weak Emission Line Galaxy at $z=9.3$"**
   - This paper reports on ultra-deep rest-frame UV spectroscopy of a z=9.3 galaxy with large assembled stellar mass and weak emission lines. The data suggest significant enrichment, strong outflows, and a recent burst of star formation. These characteristics provide insights into the early stages of galaxy evolution.

4. **"Multi-wavelength study of EP250416a / GRB 250416C: An Optically Dark Long GRB with a Late Jet Break"**
   - The study focuses on multi-wavelength observations (γ-rays, X-rays, and optical) of the transient event EP250416a, also known as GRB 250416C. Key findings include detailed afterglow analysis, classification as an X-ray rich GRB, and observation of a very late jet break.

These papers provide valuable insights into dark matter properties around black holes, the role of fermion condensates in inflationary models, early galaxy evolution during the Epoch of Reionization, and transient phenomena like gamma-ray bursts.
...
- URL: https://www.semanticscholar.org/paper/16d6372e42d690a7e9354817f46c7cd2ce149934

### 2. Informative Priors on Primordial Non-Gaussianity Bias $b_φ$ From Galaxy Formation
- **Focus:** galaxies
...
- Influential Citations: 0
- Fields of Study: Physics
- URL: https://www.semanticscholar.org/paper/422f0abee77beeb9f707a3d5a4024203d9d8bc68
...
- Categories: gr-qc, astro-ph.CO, math-ph
...
- URL: https://www.semanticscholar.org/paper/e751dee36bd0f3c1d63edaf8562c3308a35cf248
...
- Influential Citations: 0
- Fields of Study: Physics
- URL: https://www.semanticscholar.org/paper/fbdbd449379f083dbfd454ad93f795463afd1fc4
...
- Influential Citations: 0
- Fields of Study: Physics
- URL: https://www.semanticscholar.org/paper/8d17f30df316b4951e82372cc23cdb2acb8a4d04

### 6. Conformal anomaly transport induced by dark photon
- **Focus:** dark matter
- Published: 2026-04-23T13:27:00+00:00
- Authors: Marek Rogatko, Karol I. Wysokinski
- Categories: gr-qc, hep-th
- PDF: https://arxiv.org/pdf/2604.21664v1
...
- Influential Citations: 0
- Fields of Study: Physics
- URL: https://www.semanticscholar.org/paper/9e900c801075d08b9348a7b48fe7c5484a8a26b5

### 7. Constraining dark matter self-interaction from kinetic heating in neutron stars
- **Focus:** dark matter
- Published: 2026-04-23T13:17:20+00:00
...
### 8. Aspects of gravitational clustering and structure formation in the Universe
- **Focus:** galaxies
- Published: 2026-04-23T12:52:25+00:00
- Authors: Swati Gavas
- Categories: astro-ph.CO
...
### 9. Multi-wavelength study of EP250416a / GRB 250416C: An Optically Dark Long GRB with a Late Jet Break
- **Focus:** galaxies
- Published: 2026-04-23T12:44:15+00:00
...
- Categories: astro-ph.HE
- PDF: https://arxiv.org/pdf/2604.21624v1
...
### 10. Radiation properties of a regular black hole embedded in a Dehnen-type dark matter halo with a thin accretion disk
- **Focus:** dark matter
- Published: 2026-04-23T12:39:49+00:00
- Authors: Tianyou Ren, Jing-Ya Zhao, Xiaomei Liu, Rong-Jia Yang
- Categories: gr-qc
- PDF: https://arxiv.org/pdf/2604.21615v1
...
### 11. Fermion Condensate Inflation, Dynamical Waterfall Mechanism and Primordial Black Holes
- **Focus:** dark matter
- **Watchlisted:** act
- Published: 2026-04-23T10:59:00+00:00
- Authors: Stephon Alexander, Pisin Chen, Jinglong Liu, Antonino Marciano, Misao Sasaki, Xuan-Lin Su
- Categories: hep-th, gr-qc
- PDF: https://arxiv.org/pdf/2604.21535v1
...
### 12. SPURS: Bursty Star Formation in an Extremely Luminous Weak Emission Line Galaxy at $z=9.3$
- **Focus:** galaxies
- **Watchlisted:** jwst
- Published: 2026-04-23T10:23:19+00:00
...
### 13. Signatures of Very Massive Stars in the Epoch of Reionization
- **Focus:** galaxies
- **Watchlisted:** jwst
- Published: 2026-04-23T09:54:38+00:00
...
- **Solving Cosmological Puzzles using Finite Temperature $ν$SMEFT** — dark matter — https://arxiv.org/pdf/2604.21492v1
- **Supermassive Black Hole Winds in X-rays: SUBWAYS IV. Tracing Radio Emission and Unveiling the Role of Winds** — galaxies — https://arxiv.org/pdf/2604.21405v1
- **Photometric Super-Resolution for Improving Galaxy Morphological Measurements using Conditional Generative Adversarial Networks** — gravitational lensing — https://arxiv.org/pdf/2604.20195v1
- **Hamilton's Object Revisited: A challenging source redshift of a strong lensing configuration** — gravitational lensing — https://arxiv.org/pdf/2604.19867v1
- **Precision Kinematic Sunyaev--Zel'dovich Measurements Across Halo Mass and Redshift with DESI DR2 and ACT DR6: Part II. Bright Galaxy Survey and Emission-Line Galaxies** — gravitational lensing — https://arxiv.org/pdf/2604.19745v1
