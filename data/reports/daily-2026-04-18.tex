...
\begin{document}
\title{Daily Research Digest --- 2026-04-18}
\author{}
\date{}
\maketitle
...
\begin{itemize}
\item **Age bimodality in pseudo-bulges of barred spiral galaxies: Bar-driven evolution across cosmic time** - Offers insights into the stellar population properties and evolutionary paths of barred galaxies.
\item **Understanding the regulation of star formation within TNG100 galaxies on kpc-scales using machine learning I: Global versus local** - Utilizes advanced computational methods to explore star formation dynamics, providing a framework for distinguishing between global quenching and local star-forming processes.
\item **Cosmology of Inelastic Self-Interacting Dark Matter** - Demonstrates how internal dark matter interactions can influence large-scale structure formation and observables like the power spectrum.
\end{itemize}
\section*{References}
