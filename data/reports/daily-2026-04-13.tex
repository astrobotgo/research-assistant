...
\begin{document}
\title{Daily Research Digest --- 2026-04-13}
\author{}
\date{}
\maketitle
...
Recent preprints in the arXiv repository have introduced a variety of new insights into galaxy clusters, galaxies, gravitational lensing, and dark matter. Notably, there is significant progress in understanding ultra-faint satellite galaxies around the Milky Way, as well as advancements in modeling star formation rates and gas dynamics within various types of galaxies. Additionally, methodological improvements for analyzing Lyman-alpha forest data have been proposed to enhance our ability to constrain cosmological models.
\section*{Galaxy clusters}
There are no preprints directly focused on galaxy clusters in this list. This indicates a potential gap in recent submissions regarding the dynamics and evolution of these large-scale structures.
\section*{Galaxies}
Recent work has delved into understanding the missing ultra-faint satellite galaxies around the Milky Way, suggesting that there are fewer satellites at very low luminosities than expected due to tides and dark matter stripping. Another study explores extreme emission-line galaxies (EELGs) in the local universe, which serve as analogs for reionization-era galaxies, highlighting the importance of high-redshift star formation studies. Furthermore, research on the molecular Kennicutt-Schmidt relation reveals that higher-J CO transitions indicate more linear correlations between gas and star formation rates, suggesting denser gas is directly linked to ongoing star formation. Lastly, [CII] emissions from high-redshift quiescent galaxies provide insights into molecular gas fractions and dust heating mechanisms beyond standard stellar radiation.
\section*{Gravitational lensing}
There are no preprints focusing specifically on gravitational lensing in this list, indicating a potential area for future research or fewer recent developments compared to other areas.
\section*{Dark matter}
One paper explores the effective field theory (EFT) applied to the Lyman-alpha forest flux power spectrum, proposing methods to reduce computational costs and enhance model compression through Fisher matrix formalism. This work aims to better understand small-scale structure formation and its implications for dark matter models.
\section*{Cross-cutting themes}
Several papers highlight methodological advancements in analyzing galaxy data, such as using machine learning techniques (k-means) for classifying extreme emission-line galaxies and employing Fisher matrices to improve model compression for cosmological probes. Additionally, there is a consistent focus on connecting observational data with theoretical predictions through sophisticated modeling of star formation rates, gas dynamics, and the influence of dark matter.
\section*{Papers to read first}
\begin{itemize}
\item **The missing ultra-faint satellites of the Milky Way**: This paper provides important insights into the population of faint satellite galaxies around the Milky Way, crucial for understanding galaxy evolution.
\end{itemize}
\begin{itemize}
\item **The k-MENDEL sample of local analogs to reionization galaxies. Spectral identification of EELGs and properties of green peas in DESI**: This study offers a robust classification method for extreme emission-line galaxies, critical for probing early star formation processes.
\end{itemize}
\begin{itemize}
\item **Constraining the Molecular Kennicutt-Schmidt Relation with Multi-Transition CO Observations of Nearby Galaxies**: The analysis provides detailed information on how different transitions of CO relate to star formation rates in nearby galaxies, shedding light on gas dynamics and stellar evolution.
\end{itemize}
\section*{Open questions and follow-ups}
Despite advancements, there remain several open areas. For example, the exact nature and number of ultra-faint dwarf satellites is still unclear and requires more observational data. Additionally, understanding the precise mechanisms driving dust heating in high-redshift quiescent galaxies remains a key challenge. Further work on methodological improvements for analyzing large datasets, such as those from Lyman-alpha forests, will be essential to constrain cosmological parameters accurately.
\newpage
\section*{Paper Summaries and Figures}
\subsection*{1. The missing ultra-faint satellites of the Milky Way}
\textbf{Focus:} galaxies, dark matter\\
\textbf{Authors:} Isabel M. E. Santos-Santos, Carlos S. Frenk, Julio F. Navarro\\
\textbf{Published:} 2026-04-10T17:57:28+00:00\\
\textbf{PDF:} \href{https://arxiv.org/pdf/2604.09539v1}{https://arxiv.org/pdf/2604.09539v1}\\
\textbf{Summary:}
We combine the highest resolution N-body simulation of a $\sim 10^{12}\, M_\odot$ $Λ$CDM halo (Aquarius-A) with the \{\textbackslash{}sc GALFORM\} galaxy formation semianalytic model to study the full satellite population expected in a MW-like galaxy. The model assumes that galaxies only form in subhalos whose peak circular velocity exceeds the H-cooling threshold, all of which are well resolved in the simulation. The number of luminous subhalos ever accreted into the main halo is thus well defined, and implies that the total number of MW satellites, down to arbitrarily low luminosity, should not exceed a few hundred. The model tracks satellites even after their halos cease to be resolved ("orphan" galaxies), and includes a novel treatment of dark matter and stellar tidal stripping which takes into account that all $Λ$CDM subhalos survive until the present because of their cuspy inner density profiles. After accounting for tides, our results match well the massive end of the observed MW satellite mass function and predict that a large number of ultra-faint dwarfs are missing from the current MW satellite census. The missing UFDs are predicted to avoid the innermost regions of the host, and to have properties that overlap with those of the many ultra-faint compact MW satellites (UFCSs) discovered recently, with properties intermediate between globular clusters and dwarf galaxies. Our results suggest that many UFCS systems are dark matter-dominated dwarfs with velocity dispersions between $1-3$km/s, which have survived disruption because they reside in the dense cusp of $Λ$CDM subhalos. UFCSs should have mean densities of order $10^{10}$-$10^{11}\,M_\odot/$kpc$^3$, higher than those of more extended ultra-faint systems. If confirmed, our results would provide support for the cuspy nature of $Λ$CDM dark matter halos and for the hydrogen-cooling threshold for galaxy formation.
\newpage
\subsection*{2. The k-MENDEL sample of local analogs to reionization galaxies. Spectral identification of EELGs and properties of green peas in DESI}
\textbf{Focus:} galaxies\\
\textbf{Authors:} L. Bonatto, R. Amorín, A. Giménez-Alcázar, J. A. Fernández-Ontiveros, A. Hernán-Caballero, S. Suárez, J. M. Vílchez, E. Pérez-Montero, M. Llerena, J. Sánchez Almeida\\
\textbf{Published:} 2026-04-10T17:37:50+00:00\\
\textbf{PDF:} \href{https://arxiv.org/pdf/2604.09516v1}{https://arxiv.org/pdf/2604.09516v1}\\
\textbf{Summary:}
Low-mass galaxies with intense starbursts exhibit spectra dominated by extreme nebular emission and faint stellar continua. These extreme emission-line galaxies (EELGs) are key laboratories to study star formation, feedback, and ionizing photon escape in low-metallicity environments. We exploit the DESI survey to assemble the k-Means of Extreme Nebulae from DEsi outLiers (k-MENDEL), a statistically robust sample of \textasciitilde{}16,000 EELGs at 0.01 < z < 0.96 selected via automatic k-means classification. Using SED fitting and Te-based metallicities, we characterize EELGs including "blueberry" and "green pea" galaxies, spanning stellar masses of 10\textasciicircum{}6-10\textasciicircum{}10 Msun and SFRs of 0.1-100 Msun/yr. k-MENDEL extends previous SDSS samples toward higher redshifts and lower metallicities (12+log(O/H) \textasciitilde{} 7.0-8.5). EELGs lie systematically above the star-forming main sequence, with sSFRs up to \textasciitilde{}100 Gyr\textasciicircum{}-1. They follow a shallower mass-metallicity relation offset by 0.3-0.5 dex from local relations, closely resembling young galaxies observed with JWST at z > 3-10. The large intrinsic metallicity scatter, even after projecting along the fundamental metallicity relation, indicates strong departures from simple "bathtub" models, suggesting massive inflows of metal-poor gas followed by strong feedback. While \textasciitilde{}6\% of the sample shows AGN-like signatures, the most extreme star-forming systems reach high ionization (O32 \textasciitilde{} 5-60) comparable to confirmed Lyman-continuum emitters. Our results support the interpretation of EELGs as short-lived, non-equilibrium phases in the evolution of low-mass galaxies and highlight their importance as nearby analogs of galaxies likely driving cosmic reionization (Abridged).
\subsubsection*{Selected figures}
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth,height=0.42\textheight,keepaspectratio]{/home/kf/research-assistant/data/cache/figures/http-arxiv.org-abs-2604.09516v1/figure\_1.png}
\end{figure}
\newpage
\subsection*{3. Analytic compression of the effective field theory of the Lyman-alpha forest}
\textbf{Focus:} dark matter\\
\textbf{Authors:} N. G. Karaçaylı, M. Ivanov, R. de Belsunce, C. Ravoux, J. M. Sexton, Z. Lukić\\
\textbf{Published:} 2026-04-10T15:20:40+00:00\\
\textbf{PDF:} \href{https://arxiv.org/pdf/2604.09407v1}{https://arxiv.org/pdf/2604.09407v1}\\
\textbf{Summary:}
The 1D flux power spectrum ($P_{\mathrm{1D}}$) of the Ly$\alpha $ forest provides an exceptionally high-resolution probe of structure formation down to small scales ($k\approx1-10~\text{$h\textasciitilde{}$Mpc$\textasciicircum{}\{-1\}$}$). These scales carry the imprints of massive neutrinos, warm dark matter, and the running of the primordial power spectrum spectral index. The effective field theory (EFT) is a promising perturbative approach to systematically and efficiently describe the Ly$\alpha $ forest, but it faces challenges in its application to $P_{\mathrm{1D}}$, as many EFT parameters become degenerate when projected along the line of sight. In addition, this projection generates new stochastic terms from the integration over small-scale modes. In this work, we address these issues by compressing the EFT model space using the Fisher matrix formalism and linearizing the resulting compression directions, enabling analytic template marginalization and significantly reducing the computational cost of likelihood evaluation. We use hydrodynamical simulations to obtain a baseline estimate of EFT parameters, and use the DESI DR1 $P_{\mathrm{1D}}$ measurements to derive compression directions. We then marginalize over deviations from the baseline using these compression directions and forecast the constraining power of our formalism. We find that even in conservative scenarios where each data redshift bin requires its own set of EFT parameters, the cosmological constraints saturate with the linear bias, two leading-order 1D stochastic terms, and three principal combinations of the remaining EFT templates. In this case, our forecasted precision of the amplitude ($\Delta ^2_p$) and the logarithmic slope ($n_p$) of the linear matter power spectrum at the pivot scale ($k_p=0.7~\text{Mpc}^{-1}$) is $10\%$ and $2.0\%$, respectively, which is similar to emulator-based analyses that include observational data systematics.
\subsubsection*{Selected figures}
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth,height=0.42\textheight,keepaspectratio]{/home/kf/research-assistant/data/cache/figures/http-arxiv.org-abs-2604.09407v1/figure\_1.png}
\end{figure}
\newpage
\subsection*{4. Constraining the Molecular Kennicutt-Schmidt Relation with Multi-Transition CO Observations of Nearby Galaxies}
\textbf{Focus:} galaxies\\
\textbf{Authors:} Victoria G. G. Samboco, Ryan P. Keenan\\
\textbf{Published:} 2026-04-10T14:24:36+00:00\\
\textbf{PDF:} \href{https://arxiv.org/pdf/2604.09353v1}{https://arxiv.org/pdf/2604.09353v1}\\
\textbf{Summary:}
