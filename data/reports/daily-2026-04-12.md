...
- **"Coupled Dark Energy and Dark Matter for DESI: An Effective Guide to the Phantom Divide"**
  - This paper provides an essential update on dynamical dark energy models, specifically focusing on interacting quintessence fields in light of recent DESI data.
  
- **"Optical images of Kerr-Sen black hole illuminated by thick accretion disks"**
  - Offers detailed insights into black hole shadow and polarization properties under varying charge and spin conditions using advanced accretion disk illumination models.
